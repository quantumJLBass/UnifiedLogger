...
class UnifiedLogger:
    ...
    def init_loguru(self, log_level: str = 'DEBUG', log_folder: str = 'logs'):
    ...
    def display_toast(self, message: str, level: str = "info"):
        ...
        Toast(self.root, message, icon=icon_name, style=boot_style).show_toast()
    ...
    def add_stream_handler(self):
        self.log_stream_handler = logger.add(sys.stderr, level=self.log_level, format=self.log_format)

...
class UnifiedLogger:
    ...
    def display_toast(self, message: str, level: str = "info"):
        ...
        Toast(title="ttkbootstrap toast message",  message=message,duration=3000, bootstyle=boot_style,alert=Truesssssss, icon=icon_name, iconfont=None, position= (100, 100, 'se')).show_toast()

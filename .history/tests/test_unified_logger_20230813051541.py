...
class TestUnifiedLogger(unittest.TestCase):
    ...
    def test_get_icon_with_matching_height(self):
        with patch('tkfontawesome.icon_to_image') as mock_icon_to_image:
            text_label = Label(text="test")
            self.logger.get_icon_with_matching_height("info-circle", text_label)
            mock_icon_to_image.assert_called_once()
    ...
    def test_copy_to_clipboard(self):
        ...
        self.assertEqual(log.root.clipboard_get(), "Test text")
